...
const ROBOT_CONFIG = {
  robot: { x: 0, y: 0, rotate: -7, scale: 1, scaleX: 1, scaleY: 1, transformOrigin: '50% 56%', zIndex: 0, width: 450, top: 0, left: 0 },
  head: { left: 95, top: 20, width: 260, x: 0, y: 0, rotate: -3, scale: 1, scaleX: 1, scaleY: 1, transformOrigin: '50% 75%', zIndex: 6 },
  body: { left: 120, top: 150, width: 220, x: 0, y: 0, rotate: -2, scale: 1, scaleX: 1, scaleY: 1, transformOrigin: '50% 50%', zIndex: 3 },
  leftHand: { left: 45, top: 205, width: 120, x: 0, y: 0, rotate: -14, scale: 1, scaleX: 1, scaleY: 1, transformOrigin: '80% 15%', zIndex: 2 },
  rightHand: { left: 300, top: 130, width: 120, x: 0, y: 0, rotate: -6, scale: 1, scaleX: 1, scaleY: 1, transformOrigin: '15% 30%', zIndex: 2 },
  leftLeg: { left: 95, top: 330, width: 120, x: 0, y: 0, rotate: 19, scale: 1, scaleX: 1, scaleY: 1, transformOrigin: '60% 10%', zIndex: 1 },
  rightLeg: { left: 240, top: 330, width: 120, x: 0, y: 0, rotate: -18, scale: 1, scaleX: 1, scaleY: 1, transformOrigin: '45% 10%', zIndex: 1 },
};
